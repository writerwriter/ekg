...
* Hazard prediction
    ...
    * Both EKG and Heart Sound - Multi-task
        * Concordance Index - ADHF / Mortality / (MI / Stroke / CVD)
            | Training data      | Validation Data | Testing Data  | Best Model                                 | 3-Model Ensemble                           | 5-Model Ensemble                           | Sweep ID   |
            | ------------------ | --------------- | ------------- | ------------------------------------------ | ------------------------------------------ | ------------------------------------------ | ---------- |
            | 0.49 * B           | 0.21 * B        | 0.3 * B       | 0.7895 / 0.7724 / 0.7779 / 0.6155 / 0.7869 | 0.7934 / 0.7673 / 0.7468 / 0.6573 / 0.7779 | 0.7893 / 0.7726 / 0.7390 / 0.6789 / 0.7977 | `raf2io71` |
            | 0.49 * A           | 0.21 * A        | 0.3 * A       |                                            |                                            |                                            |            |
            | 0.49 * (B + A)     | 0.21 * (B + A)  | 0.3 * (B + A) |                                            |                                            |                                            |            |
            | 1.0 * B + 0.49 * A | 0.21 * A        | 0.3 * A       | 0.7975 / 0.8804                            | 0.7239 / 0.8417                            | 0.7380 / 0.8828                            | `avrv0k74` |