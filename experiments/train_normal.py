...
def train():
    ...
    model.fit(train_set[0], train_set[1], batch_size=64, epochs=200, validation_data=(valid_set[0], valid_set[1]), callbacks=callbacks, shuffle=True, class_weight={0: 0.9, 1: 0.1})
